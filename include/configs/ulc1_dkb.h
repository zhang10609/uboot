...
#define CONFIG_FACTORY_PARTITION "NVM"

#define CONFIG_FACTPART_BOARD_SN "/product_serialno"
#define CONFIG_FACTPART_USE_NVM_SN "/use_nvm_sn"
#define CONFIG_FACTPART_USE_NVM_MAC "/use_nvm_mac"
